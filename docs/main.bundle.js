...
var BlogComponent = (function () {
    function BlogComponent(blogpostService, http) {
        ...
        this.http = http;
        this.post = {};
        this.blogpost = { topic_id: 2 };
        this.uploader = new __WEBPACK_IMPORTED_MODULE_3_ng2_file_upload__["FileUploader"]({ url: 'http://api.jualishebora.gq/api/v1/images' /*http://localhost:3001/upload*/ });
...
var BlogpostService = (function () {
    ...
    BlogpostService.prototype.postFile = function (fileToUpload) {
        var _this = this;
        var endpoint = 'http://localhost:8000/api/v1/audio';
