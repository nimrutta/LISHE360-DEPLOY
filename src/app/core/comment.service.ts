...
export class CommentService {
  ...
  private commentsUrl = 'http://lishe-360.herokuapp.com/api/v1/comments'
  private commentcategoriesUrl = 'http://lishe-360.herokuapp.com/api/v1/topicsByCategory'
  private commentCategoryNameUrl = 'http://lishe-360.herokuapp.com/api/v1/topicCategories'
