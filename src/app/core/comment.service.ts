...
export class CommentService {
  ...
  private commentsUrl = 'https://lishe-360.herokuapp.com/api/v1/comments'
  private commentcategoriesUrl = 'https://lishe-360.herokuapp.com/api/v1/topicsByCategory'
  private commentCategoryNameUrl = 'https://lishe-360.herokuapp.com/api/v1/topicCategories'
